...
public class ServletVerificationCode extends HttpServlet {
     ...
     * 生成验证码
     * <p>
     * 在内存中生成图片(纸),没有设置背景颜色,画填充的矩形，并且和纸大小相同，矩形有颜色
     * <p>
     ...
     * 把内存中的图片输出到客户端
     */
    public void run(HttpServletResponse response , HttpServletRequest request) throws Exception {
        int width = 120;
        int height = 30;
        ...
        //定义字符串
        //String words = "ABCDEFGHIGKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890";
         ...
         *
         * 弧度指的是一个标准单位圆中弧长所占圆周长的比例，
         * 当 弧长=半径 时，弧度为2π，为什么是2π呢，因为圆周长=2πr，
         * r在比的过程中就消掉了，故一个圆周弧度为2π。
         *
         */
        ...
        for (int i = 0; i < 4; i++) {
            ...
            int jiaodu = random.nextInt(60) - 30; // -30° -->  30°
            double hudu = jiaodu * Math.PI / 180; // 弧度 = 角度/360° * 2π
            g.rotate(hudu,x,y);


            int index = random.nextInt(words.length()); //返回参数的 任意一个
